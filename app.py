...
def predict():
    ...
    predictor = pickle.load(open(r"C:\Users\H P\Downloads\AI\new_start\NLP_Project\model_xgb.pkl", "rb"))
    scaler = pickle.load(open(r"C:\Users\H P\Downloads\AI\new_start\NLP_Project\scaler.pkl", "rb"))
    cv = pickle.load(open(r"C:\Users\H P\Downloads\AI\new_start\NLP_Project\countVectorizer.pkl", "rb"))
    try:
